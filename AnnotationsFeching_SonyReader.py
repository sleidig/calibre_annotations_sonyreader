...
__license__ = 'GPL v3'
__copyright__ = '2017, Sebastian Leidig <sebastian.leidig@gmail.com>'
...
class SonyReaderApp(USBReader):
    ...
    def _get_db(self):
        ...
        for vol in storage:
            ...
            if os.path.exists(path):
                print('using reader database: '+path)
    ...
    def get_active_annotations(self):
        ...
        conn = self._get_db()
        for row in conn.execute('SELECT _id, content_id, added_date, marked_text, name, page FROM annotation'):
